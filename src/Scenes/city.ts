...
export function createCity(): void {
    ...
    const transform43 = new Transform({
      position: new Vector3(74.5, 0, 16.5),
      rotation: new Quaternion(0, 0, 0, 1),
      scale: new Vector3(1, 1, 1)
    })
    ...
    const transform44 = new Transform({
      position: new Vector3(75.5, 0, 23.5),
    ...
    const transform45 = new Transform({
      position: new Vector3(75.5, 0, 38),
      rotation: new Quaternion(-1.94558004621803e-15, -0.7071068286895752, 8.429369557916289e-8, 0.7071068286895752),
      scale: new Vector3(1, 1, 1)
    })
    ...
    const transform46 = new Transform({
      position: new Vector3(75.5, 0, 52),
      rotation: new Quaternion(-1.94558004621803e-15, -0.7071068286895752, 8.429369557916289e-8, 0.7071068286895752),
      scale: new Vector3(1, 1, 1)
    })
    ...
    const transform47 = new Transform({
      position: new Vector3(74.5, 0, 30.5),
      rotation: new Quaternion(0, 0, 0, 1),
      scale: new Vector3(1, 1, 1)
    })
    ...
    const transform48 = new Transform({
      position: new Vector3(74.5, 0, 45),
      rotation: new Quaternion(0, 0, 0, 1),
      scale: new Vector3(1, 1, 1)
    })
    ...
    const transform49 = new Transform({
      position: new Vector3(74.5, 0, 59),
      rotation: new Quaternion(0, 0, 0, 1),
      scale: new Vector3(1, 1, 1)
    })
    ...
    const transform50 = new Transform({
      position: new Vector3(75.5, 0, 65.5),
      rotation: new Quaternion(-1.94558004621803e-15, -0.7071068286895752, 8.429369557916289e-8, 0.7071068286895752),
      scale: new Vector3(1, 1, 1)
    })
    ...
    const transform51 = new Transform({
      position: new Vector3(74.5, 0, 72.5),
      rotation: new Quaternion(0, 0, 0, 1),
      scale: new Vector3(1, 1, 1)
    })
    ...
    const transform52 = new Transform({
      position: new Vector3(75.5, 0, 79.5),
      rotation: new Quaternion(-1.94558004621803e-15, -0.7071068286895752, 8.429369557916289e-8, 0.7071068286895752),
      scale: new Vector3(1, 1, 1)
    })
    ...
    const transform53 = new Transform({
      position: new Vector3(74.5, 0, 86),
      rotation: new Quaternion(0, 0, 0, 1),
      scale: new Vector3(1, 1, 1)
    })
    ...
    const transform179 = new Transform({
      position: new Vector3(31, 4, 56.5),
      rotation: new Quaternion(0, 0, 0, 1),
      scale: new Vector3(1, 1, 1)
    })
    ...
    const transform267 = new Transform({
      position: new Vector3(18.787866592407227, 0, 1.9999992847442627),
      rotation: new Quaternion(0, 0, 0, 1),
      scale: new Vector3(1, 1, 1)
    })
    ...
    const transform268 = new Transform({
      position: new Vector3(14.552902221679688, 0, 3.169301748275757),
    ...
    const transform271 = new Transform({
      position: new Vector3(55, 0, 2.9999966621398926),
      rotation: new Quaternion(0, 0, 0, 1),
    ...
    const transform282 = new Transform({
      position: new Vector3(71.28919982910156, 1.5256630182266235, 70.5),
      rotation: new Quaternion(0, 0, -0.7071068286895752, -0.7071068286895752),
    ...
    const transform283 = new Transform({
      position: new Vector3(71.30879974365234, 1.5, 69.5),
      rotation: new Quaternion(0, 0, 0.6343933343887329, 0.7730104923248291),
      scale: new Vector3(2, 1, 2)
    })
    ...
    const transform284 = new Transform({
      position: new Vector3(71.28919982910156, 1.5256630182266235, 57.5),
      rotation: new Quaternion(0, 0, -0.7071068286895752, -0.7071068286895752),
      scale: new Vector3(1.8314695358276367, 1.555570363998413, 2)
    })
    ...
    const transform285 = new Transform({
      position: new Vector3(71.30879974365234, 1.5, 56.5),
      rotation: new Quaternion(0, 0, 0.6343933343887329, 0.7730104923248291),
      scale: new Vector3(2, 1, 2)
    })
    ...
    const transform286 = new Transform({
      position: new Vector3(71.28919982910156, 35.025665283203125, 70.5),
      rotation: new Quaternion(0, 0, -0.7071068286895752, -0.7071068286895752),
      scale: new Vector3(1.8314695358276367, 1.555570363998413, 2)
    })
    ...
    const transform287 = new Transform({
      position: new Vector3(71.30879974365234, 35, 69.5),
      rotation: new Quaternion(0, 0, 0.6343933343887329, 0.7730104923248291),
      scale: new Vector3(2, 1, 2)
    })
    ...
    const transform288 = new Transform({
      position: new Vector3(71.28919982910156, 35.025665283203125, 57.5),
      rotation: new Quaternion(0, 0, -0.7071068286895752, -0.7071068286895752),
      scale: new Vector3(1.8314695358276367, 1.555570363998413, 2)
    })
    ...
    const transform289 = new Transform({
      position: new Vector3(71.30879974365234, 35, 56.5),
      rotation: new Quaternion(0, 0, 0.6343933343887329, 0.7730104923248291),
      scale: new Vector3(2, 1, 2)
    })
    ...
    script3.spawn(signpostTree2, {"text":"Neo Dragon City Hall\nGET ACCESS CARD","fontSize":20}, createChannel(channelId, signpostTree2, channelBus))
    ...
    script14.spawn(signpostTree5, {"text":"Green: Go up Neo DCL Tower\nRed: Call Elevator","fontSize":24}, createChannel(channelId, signpostTree5, channelBus))
}